...
public class SportsSingleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sports_single_fragment, container, false);
        recyclerTeam = (RecyclerView) view.findViewById(R.id.sports_single_recycle);
