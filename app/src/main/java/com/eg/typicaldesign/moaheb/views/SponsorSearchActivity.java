...
public class SponsorSearchActivity extends BaseActivitySponsor {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sponsor_search);
    ...
    int getContentViewId() {
        return R.layout.activity_sponsor_search;
    }

    @Override
    int getNavigationMenuItemId() {
        return R.id.navigation1_search;
    }
