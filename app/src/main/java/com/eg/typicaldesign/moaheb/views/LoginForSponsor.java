...
public class LoginForSponsor extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_for_sponsor);
    ...
    public void onClick(View view) {
        ...
        if (view == submit) {
            ...
            Service.Fetcher.getInstance().loginSponsor(phone, pass).enqueue(new Callback<GeneralResponse>() {
                ...
                public void onResponse(Call<GeneralResponse> call, Response<GeneralResponse> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (status == 1) {
                            ...
                            Intent intent = new Intent(LoginForSponsor.this, SportsContainerActivity.class);
                            startActivity(intent);
                            finish();
                            ...
                            for (int i = 0; i < response.body().getMessages().size(); i++) {
                                ...
                                Toast.makeText(LoginForSponsor.this, message, Toast.LENGTH_LONG).show();
                ...
                public void onFailure(Call<GeneralResponse> call, Throwable t) {
                    Log.e("TAG", "onFailure ");
                    progressDialog.dismiss();
                    Toast.makeText(LoginForSponsor.this, t.getMessage(), Toast.LENGTH_LONG).show();
