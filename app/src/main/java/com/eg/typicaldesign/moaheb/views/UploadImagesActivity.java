...
public class UploadImagesActivity extends BaseActivityPlayer implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view == myImages) {
            Intent intent = new Intent(this, PlayerImagesActivity.class);
        ...
        if (view == addImage) {
            ...
            if (selectedImagePath == null) {
                ...
                Toast.makeText(UploadImagesActivity.this, "برجاء اختيار صورة", Toast.LENGTH_SHORT).show();
            } else {
                ...
                Service.Fetcher.getInstance().uploadImage(imagePart, apiToken, type1
                    ...
                    public void onResponse(Call<GeneralResponse> call, Response<GeneralResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (status == 1) {
                                ...
                                progressDialog.dismiss();
                                Toast.makeText(UploadImagesActivity.this, "تم إضافة الصورة بنجاح", Toast.LENGTH_LONG).show();
                                ...
                                for (int i = 0; i < response.body().getMessages().size(); i++) {
                                    ...
                                    Toast.makeText(UploadImagesActivity.this, message, Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE && resultCode == RESULT_OK && data != null && data.getData() != null && resultCode != RESULT_CANCELED) {
            ...
            selectedImagePath = getRealPath(uri, UploadImagesActivity.this);
...
//                bitmap.compress(Bitmap.CompressFormat.JPEG, 100, bytes);
                ...
                uri = Uri.parse(path);
                selectedImagePath = getRealPathFromURI(uri, UploadImagesActivity.this);
